...
public class AuthTest {
    ...
    public void deveObterClima() {
        given()
                ...
                .queryParam("appId", "1d2491d7183bdefb94437fa3cd8a7277")
    ...
    public void deveFazerAutenticacaoComTokenJWT() {
        ...
        login.put("email", "johnny99@outleak.com");
        login.put("senha", "1234567890");
    ...
    public void deveAcessarAplicacaoWeb() {
        String cookie = given()
                .log().all()
                .formParam("email", "johnny99@outleak.com")
                .formParam("senha", "1234567890")
